...
An 3 Freitagen finden Turniere im Format [Duel Commander](https://www.duelcommander.org/banlist/) statt:
...
- [Regeln](https://www.duelcommander.org/rules/quickrules/)
- [Banlist](https://www.duelcommander.org/banlist/)
